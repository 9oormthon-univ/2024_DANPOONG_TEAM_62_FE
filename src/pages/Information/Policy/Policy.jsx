...
const Policy = () => {
    ...
    const fetchEducationData = async (page) => {
        const url = `https://apis.data.go.kr/1390000/youngV2/policyListV2?typeDv=json&serviceKey=${YOUNG_FARMER_API_KEY}&rowCnt=10&cp=${page}`;
        ...
        try {
            ...
            const filteredEduList = data.policy_list.filter(edu => {
            ...
            // setTotalPages(data.policy_paging.lastPage);
            setTotalPages(49);
                    ...
                    <S.Table>
                        <thead >
                            <tr >
                                ...
                                <S.TableHeader style={{width:'50%'}}>사업명</S.TableHeader>
